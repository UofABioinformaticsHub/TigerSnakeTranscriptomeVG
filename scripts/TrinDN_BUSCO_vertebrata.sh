...
#SBATCH --mem=32GB
#SBATCH -o /home/a1671704/fastdir/Data_TigerSnake/3_transcriptomeAssembly/trinity/slurm/TrinDN_BUSCO_vertebrata_%j.out
#SBATCH -e /home/a1671704/fastdir/Data_TigerSnake/3_transcriptomeAssembly/trinity/slurm/TrinDN_BUSCO_vertebrata_%j.err
...
# run busco
BUSCO.py -i ${ASSEMDIR}/Trinity.fasta -o busco_TrinityDN_vertebrata -l ${LINDIR}/vertebrata_odb9 -m tran -f
