...
#SBATCH --mem=16GB
#SBATCH -o /home/a1671704/fastdir/Data_TigerSnake/3_transcriptomeAssembly/cdHITandDeNovo/qualityAssessment/slurm/BUSCO_metazoa_%j.out
#SBATCH -e /home/a1671704/fastdir/Data_TigerSnake/3_transcriptomeAssembly/cdHITandDeNovo/qualityAssessment/slurm/BUSCO_metazoa_%j.err
...
# run busco
BUSCO.py -i ${ASSEMDIR}/collaspedTrinityDeNovo90 -o cdHIT_busco_metazoa -l ${LINDIR}/metazoa_odb9 -m tran -f
