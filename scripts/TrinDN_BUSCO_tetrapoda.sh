...
#SBATCH --mem=32GB
#SBATCH -o /home/a1671704/fastdir/Data_TigerSnake/3_transcriptomeAssembly/trinity/slurm/TrinDN_BUSCO_tetrapoda_%j.out
#SBATCH -e /home/a1671704/fastdir/Data_TigerSnake/3_transcriptomeAssembly/trinity/slurm/TrinDN_BUSCO_tetrapoda_%j.err
...
# run busco
BUSCO.py -i ${ASSEMDIR}/Trinity.fasta -o busco_TrinityDN_tetrapoda -l ${LINDIR}/tetrapoda_odb9 -m tran -f
